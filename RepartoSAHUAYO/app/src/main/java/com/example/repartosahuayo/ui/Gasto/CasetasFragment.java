 ...
 */
public class CasetasFragment extends Fragment {
    private Button terminar_caseta;
    private EditText importe_gasto;
    private Spinner tipodegasto;


    public CasetasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_casetas, container, false);
        terminar_caseta = rootView.findViewById(R.id.terminar_caseta);
        importe_gasto = rootView.findViewById(R.id.importe_casetas);
        tipodegasto = rootView.findViewById(R.id.spinner_casetas);
    ...
    private void GastoCaseta(View v){
        terminar_caseta.setOnClickListener(new View.OnClickListener() {
            @Override
