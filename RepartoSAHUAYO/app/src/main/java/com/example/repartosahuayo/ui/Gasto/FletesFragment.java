 ...
 */
public class FletesFragment extends Fragment {
    private Button terminar_flete;
    private EditText importe_gasto;
    private Spinner tipodegasto;


    public FletesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_fletes, container, false);
        terminar_flete = rootView.findViewById(R.id.terminar_fletes);
        importe_gasto = rootView.findViewById(R.id.importe_fletes);
        tipodegasto = rootView.findViewById(R.id.spinner_fletes);
        GastoFletes(rootView);
        Spinner();
        Back(rootView);
    ...
    private void GastoFletes(View v){
        terminar_flete.setOnClickListener(new View.OnClickListener() {
            @Override
